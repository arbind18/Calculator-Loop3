...
import { Home, TrendingUp, PieChart as PieChartIcon } from "lucide-react"
...
export function HomeLoanEMI() {
  ...
  const handleDownload = (format: string) => {
    ...
    generateReport(format, 'home_loan_schedule', headers, data, 'Home Loan EMI Schedule', {
  ...
  return (
    <FinancialCalculatorTemplate
      ...
      description="Calculate your monthly home loan EMI and view detailed amortization schedule"
      icon={Home}
