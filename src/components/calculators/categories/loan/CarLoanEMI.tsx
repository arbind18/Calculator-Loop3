...
export function CarLoanEMI() {
  ...
  const handleDownload = (format: string) => {
    ...
    generateReport(format, 'car_loan_schedule', headers, data, 'Car Loan EMI Schedule', {
  ...
  return (
    <FinancialCalculatorTemplate
      ...
      description="Calculate your monthly car loan EMI and view detailed amortization schedule"
      icon={Car}
