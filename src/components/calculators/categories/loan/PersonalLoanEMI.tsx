...
export function PersonalLoanEMI() {
  ...
  const handleDownload = (format: string, options?: DownloadOptions) => {
    ...
    generateReport(format, "personal_loan_schedule", headers, data, t.loan.personal_loan_title, metadata)
  }
  ...
  return (
    <FinancialCalculatorTemplate
      title={t.loan.personal_loan_title}
      description={t.loan.personal_loan_desc}
      icon={DollarSign}
        ...
        <div className="mt-6 space-y-6">
          <Tabs value={scenario} onValueChange={(v) => setScenario(v as any)}>
            <div className="flex flex-col gap-4">
              ...
              <TabsContent value="pessimistic" className="mt-0">
                {pessimisticResult && (
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
