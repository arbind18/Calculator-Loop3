...
export function BusinessLoanEMI() {
  ...
  const handleDownload = (format: string) => {
    ...
    generateReport(format, 'business_loan_schedule', headers, data, 'Business Loan EMI Schedule', {
  ...
  return (
    <FinancialCalculatorTemplate
      ...
      description="Calculate your monthly business loan EMI and view detailed amortization schedule"
      icon={Briefcase}
